    ...
    for(let i=0 ; i < arr.length ;i++){
        ...
        <div class="col-md-3">
            <div class="content position-relative overflow-hidden rounded-3" onclick="getMealDetails(${arr[i].idMeal})">
                ...
                <div class="layout position-absolute d-flex align-items-center text-black p-2">
                    <h3>${arr[i].strMeal}</h3>
                </div>
            </div>
        </div>
...
function displayMealDetails(arr){
    ...
    //     tag += `<li class="text p-1 me-3 my-1 rounded-2">${tags[i]}</li>`
    // }
    let box="";
        box =`
        <div class="col-md-4">
    ...
    <div class="col-md-8">
        ...
        <ul class="list-unstyled d-flex flex-wrap w-75">
            <li class="text p-1 me-3 my-1 rounded-2">${arr.strTags}</li>
        </ul>
...
function displayArea(arr){
    ...
    for(let i=0 ;i<arr.length ;i++){
        box +=`
            <div class="col-md-3 area" onclick="getMealsArea('${arr[i].strArea}')">
            <div class="icon">
...
function displayIngredients(arr){
    ...
    for(let i=0 ; i<arr.length ;i++){
        box +=`
        <div class="col-md-3 area" onclick="getMealsIngredient('${arr[i].strIngredient}')">
        <div class="icon">
